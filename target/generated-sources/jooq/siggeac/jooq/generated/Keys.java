...
import siggeac.jooq.generated.tables.Affectation;
import siggeac.jooq.generated.tables.Competence;
import siggeac.jooq.generated.tables.Cours;
import siggeac.jooq.generated.tables.Disponibilite;
import siggeac.jooq.generated.tables.Etudiant;
import siggeac.jooq.generated.tables.Evaluation;
import siggeac.jooq.generated.tables.Groupe;
import siggeac.jooq.generated.tables.Inscription;
import siggeac.jooq.generated.tables.Offre;
import siggeac.jooq.generated.tables.Prealable;
import siggeac.jooq.generated.tables.Professeur;
import siggeac.jooq.generated.tables.ProfesseurBureauAbs;
import siggeac.jooq.generated.tables.ProfesseurBureauPre;
import siggeac.jooq.generated.tables.records.AffectationRecord;
import siggeac.jooq.generated.tables.records.CompetenceRecord;
...
import siggeac.jooq.generated.tables.records.EvaluationRecord;
import siggeac.jooq.generated.tables.records.GroupeRecord;
import siggeac.jooq.generated.tables.records.InscriptionRecord;
import siggeac.jooq.generated.tables.records.OffreRecord;
import siggeac.jooq.generated.tables.records.PrealableRecord;
import siggeac.jooq.generated.tables.records.ProfesseurBureauAbsRecord;
...
public class Keys {
    ...
    public static final UniqueKey<InscriptionRecord> INSCRIPTION_CC0 = Internal.createUniqueKey(Inscription.INSCRIPTION, DSL.name("inscription_cc0"), new TableField[] { Inscription.INSCRIPTION.MATRICULEE, Inscription.INSCRIPTION.SIGLE, Inscription.INSCRIPTION.TRIMESTRE, Inscription.INSCRIPTION.NOGROUPE }, true);
    ...
    public static final ForeignKey<AffectationRecord, GroupeRecord> AFFECTATION__AFFECTATION_CR0 = Internal.createForeignKey(Affectation.AFFECTATION, DSL.name("affectation_cr0"), new TableField[] { Affectation.AFFECTATION.SIGLE, Affectation.AFFECTATION.TRIMESTRE, Affectation.AFFECTATION.NOGROUPE }, Keys.GROUPE_CC0, new TableField[] { Groupe.GROUPE.SIGLE, Groupe.GROUPE.TRIMESTRE, Groupe.GROUPE.NOGROUPE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AffectationRecord, ProfesseurRecord> AFFECTATION__AFFECTATION_CR1 = Internal.createForeignKey(Affectation.AFFECTATION, DSL.name("affectation_cr1"), new TableField[] { Affectation.AFFECTATION.MATRICULEP }, Keys.PROFESSEUR_CC0, new TableField[] { Professeur.PROFESSEUR.MATRICULEP }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<CompetenceRecord, CoursRecord> COMPETENCE__COMPETENCE_CR0 = Internal.createForeignKey(Competence.COMPETENCE, DSL.name("competence_cr0"), new TableField[] { Competence.COMPETENCE.SIGLE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<CompetenceRecord, ProfesseurRecord> COMPETENCE__COMPETENCE_CR1 = Internal.createForeignKey(Competence.COMPETENCE, DSL.name("competence_cr1"), new TableField[] { Competence.COMPETENCE.MATRICULEP }, Keys.PROFESSEUR_CC0, new TableField[] { Professeur.PROFESSEUR.MATRICULEP }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<DisponibiliteRecord, CoursRecord> DISPONIBILITE__DISPONIBILITE_CR0 = Internal.createForeignKey(Disponibilite.DISPONIBILITE, DSL.name("disponibilite_cr0"), new TableField[] { Disponibilite.DISPONIBILITE.TRIMESTRE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<EvaluationRecord, InscriptionRecord> EVALUATION__EVALUATION_CR0 = Internal.createForeignKey(Evaluation.EVALUATION, DSL.name("evaluation_cr0"), new TableField[] { Evaluation.EVALUATION.SIGLE, Evaluation.EVALUATION.TRIMESTRE, Evaluation.EVALUATION.NOGROUPE, Evaluation.EVALUATION.MATRICULEE }, Keys.INSCRIPTION_CC0, new TableField[] { Inscription.INSCRIPTION.MATRICULEE, Inscription.INSCRIPTION.SIGLE, Inscription.INSCRIPTION.TRIMESTRE, Inscription.INSCRIPTION.NOGROUPE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<GroupeRecord, CoursRecord> GROUPE__GROUPE_CR0 = Internal.createForeignKey(Groupe.GROUPE, DSL.name("groupe_cr0"), new TableField[] { Groupe.GROUPE.SIGLE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<InscriptionRecord, GroupeRecord> INSCRIPTION__INSCRIPTION_CR0 = Internal.createForeignKey(Inscription.INSCRIPTION, DSL.name("inscription_cr0"), new TableField[] { Inscription.INSCRIPTION.SIGLE, Inscription.INSCRIPTION.TRIMESTRE, Inscription.INSCRIPTION.NOGROUPE }, Keys.GROUPE_CC0, new TableField[] { Groupe.GROUPE.SIGLE, Groupe.GROUPE.TRIMESTRE, Groupe.GROUPE.NOGROUPE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<OffreRecord, CoursRecord> OFFRE__OFFRE_CR0 = Internal.createForeignKey(Offre.OFFRE, DSL.name("offre_cr0"), new TableField[] { Offre.OFFRE.SIGLE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PrealableRecord, CoursRecord> PREALABLE__PREALABLE_CR0 = Internal.createForeignKey(Prealable.PREALABLE, DSL.name("prealable_cr0"), new TableField[] { Prealable.PREALABLE.SIGLE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PrealableRecord, CoursRecord> PREALABLE__PREALABLE_CR1 = Internal.createForeignKey(Prealable.PREALABLE, DSL.name("prealable_cr1"), new TableField[] { Prealable.PREALABLE.SIGLEPREALABLE }, Keys.COURS_CC0, new TableField[] { Cours.COURS.SIGLE }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
