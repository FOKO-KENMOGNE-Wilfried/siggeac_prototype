...
/**
 * Désinscrit un étudiant d'un groupe de cours.
 */
@SuppressWarnings({ "all", "unchecked", "rawtypes", "this-escape" })
public class RetirerInscription extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>retirer_inscription.p_matriculee</code>.
     */
    ...
    /**
     * The parameter <code>retirer_inscription.p_nogroupe</code>.
     */
     ...
     */
    public RetirerInscription() {
        super("retirer_inscription", DefaultSchema.DEFAULT_SCHEMA, DSL.comment("Désinscrit un étudiant d'un groupe de cours."));
