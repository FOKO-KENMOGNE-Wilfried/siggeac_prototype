...
/**
 * Retire une affectation d'un professeur.
 */
...
public class RetirerAffectation extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter <code>retirer_affectation.p_nogroupe</code>.
     */
    ...
    public RetirerAffectation() {
        super("retirer_affectation", DefaultSchema.DEFAULT_SCHEMA, DSL.comment("Retire une affectation d'un professeur."));
