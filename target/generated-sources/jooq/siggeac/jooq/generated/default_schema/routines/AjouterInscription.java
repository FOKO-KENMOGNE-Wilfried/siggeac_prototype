...
/**
 * Inscrit un étudiant à un groupe de cours, après vérification des préalables.
 */
@SuppressWarnings({ "all", "unchecked", "rawtypes", "this-escape" })
public class AjouterInscription extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>ajouter_inscription.p_matriculee</code>.
     */
    ...
    /**
     * The parameter <code>ajouter_inscription.p_nogroupe</code>.
     */
    ...
    public AjouterInscription() {
        super("ajouter_inscription", DefaultSchema.DEFAULT_SCHEMA, DSL.comment("Inscrit un étudiant à un groupe de cours, après vérification des préalables."));
