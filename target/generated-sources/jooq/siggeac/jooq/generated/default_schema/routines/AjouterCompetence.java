...
/**
 * Ajoute une compétence à un professeur.
 */
...
public class AjouterCompetence extends AbstractRoutine<java.lang.Void> {
    ...
    public AjouterCompetence() {
        super("ajouter_competence", DefaultSchema.DEFAULT_SCHEMA, DSL.comment("Ajoute une compétence à un professeur."));
