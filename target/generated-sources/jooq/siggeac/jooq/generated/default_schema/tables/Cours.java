...
import siggeac.jooq.generated.default_schema.tables.Competence.CompetencePath;
import siggeac.jooq.generated.default_schema.tables.Disponibilite.DisponibilitePath;
import siggeac.jooq.generated.default_schema.tables.Groupe.GroupePath;
import siggeac.jooq.generated.default_schema.tables.Offre.OffrePath;
import siggeac.jooq.generated.default_schema.tables.Prealable.PrealablePath;
...
public class Cours extends TableImpl<CoursRecord> {
    ...
    /**
     * The reference instance of <code>cours</code>
     */
    ...
    /**
     * The column <code>cours.sigle</code>.
     */
    ...
    /**
     * The column <code>cours.titre</code>.
     */
    ...
    /**
     * The column <code>cours.credit</code>.
     */
    ...
    /**
     * Create an aliased <code>cours</code> table reference
     */
    ...
    /**
     * Create a <code>cours</code> table reference
     */
    public Cours() {
    ...
    /**
     * Get the implicit to-many join path to the <code>competence</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>disponibilite</code>
     * table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>groupe</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>offre</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>prealable</code> table,
     * via the <code>prealable_cr0</code> key
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>prealable</code> table,
     * via the <code>prealable_cr1</code> key
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>professeur</code>
     * table, via the <code>competence_cr1</code> key
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>professeur</code>
     * table, via the <code>disponibilite_cr1</code> key
     */
