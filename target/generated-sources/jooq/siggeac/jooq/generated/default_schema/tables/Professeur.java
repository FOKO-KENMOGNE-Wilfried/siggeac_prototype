...
import siggeac.jooq.generated.default_schema.tables.Affectation.AffectationPath;
...
import siggeac.jooq.generated.default_schema.tables.ProfesseurBureauAbs.ProfesseurBureauAbsPath;
import siggeac.jooq.generated.default_schema.tables.ProfesseurBureauPre.ProfesseurBureauPrePath;
...
public class Professeur extends TableImpl<ProfesseurRecord> {
    ...
    /**
     * The reference instance of <code>professeur</code>
     */
    ...
    /**
     * The column <code>professeur.matriculep</code>.
     */
    ...
    /**
     * The column <code>professeur.nom</code>.
     */
    ...
    /**
     * Create an aliased <code>professeur</code> table reference
     */
    ...
    /**
     * Create a <code>professeur</code> table reference
     */
    public Professeur() {
    ...
    /**
     * Get the implicit to-many join path to the <code>affectation</code> table
     */
     ...
     * <code>professeur_bureau_abs</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>professeur_bureau_pre</code> table
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>cours</code> table,
     * via the <code>competence_cr0</code> key
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>cours</code> table,
     * via the <code>disponibilite_cr0</code> key
     */
